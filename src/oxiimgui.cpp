...
#define NUM_BACK_BUFFERS 3
  ...
  void OXIImGuiBegFrame(UIData* data) {
    ...
    ImGui::BeginChild("Registers", ImVec2(300, 310), ImGuiChildFlags_Border, ImGuiWindowFlags_None);
    ...
    char instructionsString[1024] = {0};
    decodeInstruction(data->itext, sizeof(data->itext), instructionsString, sizeof(instructionsString));

    ImGui::BeginChild("Disassembly", ImVec2(0, 400), ImGuiChildFlags_Border, ImGuiWindowFlags_None);
    {
      ImGui::PushStyleVar(ImGuiStyleVar_ChildRounding, 5.0f);
      ImGui::BeginChild("ChildR", ImVec2(0, 300), ImGuiChildFlags_Border, ImGuiWindowFlags_None);
